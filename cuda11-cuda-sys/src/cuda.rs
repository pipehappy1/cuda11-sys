...
pub type CUhostFn = ::std::option::Option<unsafe extern "C" fn(userData: *mut ::libc::c_void)>;
#[repr(u32)]
#[non_exhaustive]
...
pub type CUoccupancyB2DSize =
    ::std::option::Option<unsafe extern "C" fn(blockSize: ::libc::c_int) -> usize>;
...
pub type CUmemGenericAllocationHandle = ::libc::c_ulonglong;
#[repr(u32)]
#[non_exhaustive]
...
pub struct CUmemAllocationProp_st__bindgen_ty_1 {
    ...
    pub reserved: [::libc::c_uchar; 6usize],
}
#[test]
...
extern "C" {
    pub fn cuDevicePrimaryCtxSetFlags_v2(dev: CUdevice, flags: ::libc::c_uint) -> CUresult;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = " ::cuCtxSetLimit,"]
    #[doc = " ::cuCtxSynchronize"]
    pub fn cuCtxAttach(pctx: *mut CUcontext, flags: ::libc::c_uint) -> CUresult;
}
extern "C" {
...
extern "C" {
    pub fn cuMemAllocHost_v2(pp: *mut *mut ::libc::c_void, bytesize: usize) -> CUresult;
}
extern "C" {
...
extern "C" {
    pub fn cuMemsetD8_v2(dstDevice: CUdeviceptr, uc: ::libc::c_uchar, N: usize) -> CUresult;
}
extern "C" {
    pub fn cuMemsetD16_v2(dstDevice: CUdeviceptr, us: ::libc::c_ushort, N: usize) -> CUresult;
}
extern "C" {
    pub fn cuMemsetD32_v2(dstDevice: CUdeviceptr, ui: ::libc::c_uint, N: usize) -> CUresult;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = " ::cuLaunchGridAsync,"]
    #[doc = " ::cuLaunchKernel"]
    pub fn cuFuncSetSharedSize(hfunc: CUfunction, bytes: ::libc::c_uint) -> CUresult;
}
extern "C" {
    ...
    #[doc = " ::cuLaunchGridAsync,"]
    #[doc = " ::cuLaunchKernel"]
    pub fn cuParamSetSize(hfunc: CUfunction, numbytes: ::libc::c_uint) -> CUresult;
}
extern "C" {
    ...
    #[doc = " ::cuLaunchGridAsync,"]
    #[doc = " ::cuLaunchKernel"]
    pub fn cuParamSeti(hfunc: CUfunction, offset: ::libc::c_int, value: ::libc::c_uint)
        -> CUresult;
}
extern "C" {
    ...
    #[doc = " ::cuLaunchGridAsync,"]
    #[doc = " ::cuLaunchKernel"]
    pub fn cuParamSetf(hfunc: CUfunction, offset: ::libc::c_int, value: f32) -> CUresult;
}
extern "C" {
...
extern "C" {
    ...
    pub fn cuLaunchGrid(
        f: CUfunction,
        grid_width: ::libc::c_int,
        grid_height: ::libc::c_int,
    ) -> CUresult;
}
extern "C" {
    #[doc = " \\brief Launches a CUDA function"]
...
extern "C" {
    ...
    #[doc = " ::cuGraphGetEdges,"]
    #[doc = " ::cuGraphClone"]
    pub fn cuGraphCreate(phGraph: *mut CUgraph, flags: ::libc::c_uint) -> CUresult;
}
extern "C" {
...
extern "C" {
    #[doc = " \\brief Initialize the profiling."]
    #[doc = ""]
    #[doc = " \\deprecated"]
    #[doc = ""]
    #[doc = " Using this API user can initialize the CUDA profiler by specifying"]
    #[doc = " the configuration file, output file and output file format. This"]
    #[doc = " API is generally used to profile different set of counters by"]
    #[doc = " looping the kernel launch. The \\p configFile parameter can be used"]
    #[doc = " to select profiling options including profiler counters. Refer to"]
    #[doc = " the \"Compute Command Line Profiler User Guide\" for supported"]
    #[doc = " profiler options and counters."]
    #[doc = ""]
    #[doc = " Limitation: The CUDA profiler cannot be initialized with this API"]
    #[doc = " if another profiling tool is already active, as indicated by the"]
    #[doc = " ::CUDA_ERROR_PROFILER_DISABLED return code."]
    #[doc = ""]
    #[doc = " Typical usage of the profiling APIs is as follows:"]
    #[doc = ""]
    #[doc = " for each set of counters/options\\n"]
    #[doc = " {\\n"]
    #[doc = "     cuProfilerInitialize(); //Initialize profiling, set the counters or options in the config file \\n"]
    #[doc = "     ...\\n"]
    #[doc = "     cuProfilerStart(); \\n"]
    #[doc = "     // code to be profiled \\n"]
    #[doc = "     cuProfilerStop(); \\n"]
    #[doc = "     ...\\n"]
    #[doc = "     cuProfilerStart(); \\n"]
    #[doc = "     // code to be profiled \\n"]
    ...
    #[doc = " }\\n"]
    #[doc = ""]
    #[doc = " \\param configFile - Name of the config file that lists the counters/options"]
    #[doc = " for profiling."]
    #[doc = " \\param outputFile - Name of the outputFile where the profiling results will"]
    #[doc = " be stored."]
    #[doc = " \\param outputMode - outputMode, can be ::CU_OUT_KEY_VALUE_PAIR or ::CU_OUT_CSV."]
    #[doc = ""]
    #[doc = " \\return"]
    #[doc = " ::CUDA_SUCCESS,"]
    #[doc = " ::CUDA_ERROR_INVALID_CONTEXT,"]
    #[doc = " ::CUDA_ERROR_INVALID_VALUE,"]
    #[doc = " ::CUDA_ERROR_PROFILER_DISABLED"]
    #[doc = " \\notefnerr"]
    #[doc = ""]
    #[doc = " \\sa"]
    #[doc = " ::cuProfilerStart,"]
    #[doc = " ::cuProfilerStop,"]
    #[doc = " ::cudaProfilerInitialize"]
    pub fn cuProfilerInitialize(
        configFile: *const ::libc::c_char,
        outputFile: *const ::libc::c_char,
        outputMode: CUoutput_mode,
    ) -> CUresult;
}
extern "C" {
    #[doc = " \\brief Enable profiling."]
    #[doc = ""]
    #[doc = " Enables profile collection by the active profiling tool for the"]
    #[doc = " current context. If profiling is already enabled, then"]
    #[doc = " cuProfilerStart() has no effect."]
    #[doc = ""]
    #[doc = " cuProfilerStart and cuProfilerStop APIs are used to"]
    #[doc = " programmatically control the profiling granularity by allowing"]
    #[doc = " profiling to be done only on selective pieces of code."]
    #[doc = ""]
    #[doc = ""]
    #[doc = " \\return"]
    #[doc = " ::CUDA_SUCCESS,"]
    ...
    #[doc = ""]
    #[doc = " \\sa"]
    #[doc = " ::cuProfilerInitialize,"]
    #[doc = " ::cuProfilerStop,"]
    #[doc = " ::cudaProfilerStart"]
    pub fn cuProfilerStart() -> CUresult;
}
extern "C" {
    #[doc = " \\brief Disable profiling."]
    #[doc = ""]
    #[doc = " Disables profile collection by the active profiling tool for the"]
    #[doc = " current context. If profiling is already disabled, then"]
    #[doc = " cuProfilerStop() has no effect."]
    #[doc = ""]
    #[doc = " cuProfilerStart and cuProfilerStop APIs are used to"]
    #[doc = " programmatically control the profiling granularity by allowing"]
    #[doc = " profiling to be done only on selective pieces of code."]
